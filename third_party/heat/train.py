...
def main():
    ...
    if args.resume:
        ...
        # Skip optimizer and scheduler if missing (for fine-tuning)
        if 'optimizer' in ckpt:
            try:
                optimizer.load_state_dict(ckpt['optimizer'])
                print("✅ Loaded optimizer state")
            except:
                print("⚠️ Optimizer mismatch — skipping")
        ...
        if 'lr_scheduler' in ckpt:
            try:
                ...
                print("⚠️ LR scheduler mismatch — skipping")
    ...
    # 🔒 Freeze the ResNet backbone for fine-tuning
