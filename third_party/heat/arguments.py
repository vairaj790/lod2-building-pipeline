...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='./checkpoints/my_finetune_256',
                        help='path where to save, empty for no saving')
    parser.add_argument('--resume', default='./checkpoints/ckpts_heat_outdoor_256/checkpoint.pth',
                        help='resume from checkpoint')
    parser.add_argument('--start_epoch', default=0, type=int, metavar='N',
                        help='start epoch')
    parser.add_argument('--num_workers', default=4, type=int)
    parser.add_argument('--image_size', default=256, type=int)
    parser.add_argument('--max_corner_num', default=100, type=int,
    ...
    parser.add_argument('--lambda_corner', default=0.05, type=float,
                        help='corner supervision loss weight')
